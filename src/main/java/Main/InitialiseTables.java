...
public class InitialiseTables {
  ...
  public static void Initialise_all_tables() {
    ...
    try {
      ...
      sqlQ = "INSERT INTO Listings (room_type, latitude, longitude, postal_code, city, country, apt_name) VALUES ('room', 1043, 1829, 'A', 'A', 'A', 'A'),\n" +
...
//              " ('house', 3452, 3413, 'Kf', 'gf', 'Mf', 'Pf'), ('room', 34542, " +
...
//              "('room', 453452, 341443, 'Krg', 'G', 'M', 'Pfg'), ('apartment', 3452, 3413, 'K', 'G', 'M', 'P'), ('house', 342452, 345413, 'L', 'G', 'M', 'Pr') \n";
      ...
      sqlQ = "create table Calender(\n" +
              ...
              "\tprimary key(date, listing_ID), index(listing_ID), index(date))\n" ;
...
//      ps.close();
      ...
      sqlQ = "INSERT INTO Renter VALUES (8,'1293-9287'), (9,'1293-9287'), (10,'1293-9287'), (11,'1293-9287')," +
              " (12,'1293-9287'), (13,'1293-9287'), (14,'1293-9287')\n ";
      sql.executeUpdate(sqlQ);
...
//      ps.close();
      ...
      sqlQ = "INSERT INTO owns(SIN, listing_ID) VALUES (1, 1), (1, 2), (1, 3), (2, 4), (2, 5), (3, 6)";

//         //     " (3, 7), (3, 8), (3, 9), (6, 10), (1, 11), (1, 12), (4, 13), (5, 14)";
      //System.out.println("Prepared Statement: " + sqlQ.replaceAll("\\s+", " ") + "\n");
      sql.executeUpdate(sqlQ);
...
//      ps.close();
      ...
      sqlQ = "INSERT INTO Bookings " +
              ...
              "(1, 8, '2021-12-01','2021-12-03', 1), " +
              "(1, 8, '2021-10-01','2021-10-03', 1), " +
              "(1, 9, '2021-09-01','2021-09-03', 1), " +
              "(2, 9, '2021-06-01','2021-06-03', 1), " +
              "(3, 10, '2021-09-01','2021-09-03', 1), " +

              "(1, 8, '2022-01-01','2022-01-03', 0), " +
              "(4, 8, '2022-01-05','2022-01-06', 0), " +
              "(1, 9, '2022-01-04','2022-01-06', 0), " +
              "(3, 9, '2022-01-01','2022-01-03', 0) " +
...
//              "(1, 14, '2022-03-01','2022-03-03', 1),"  +
  //            "(2, 14, '2022-07-04', '2022-07-05', 0)\n";
      ...
      sqlQ = "INSERT INTO rents (SIN, listing_ID, booking_ID) VALUES " +
              "(8, 1, 1), (8, 1, 2), (9, 1, 3), (9, 2, 4), (10, 3, 5), (8, 1, 6), (8, 4, 7), (9, 1, 8), (9, 3, 9)" +
            //  "(8, 2), (14, 3), (9, 6), (13, 8), (13, 9), (12, 12), (14, 14)\n";
              "\n";
      sql.executeUpdate(sqlQ);
...
//      ps.close();
      ...
      sqlQ = "INSERT INTO Cancellations (booking_ID, listing_ID, renter_ID, date, price, renter_or_host, " +
              "cancelled) VALUES " +
              "(1, 1, 8, '2021-12-01', 40, 1, 0),\n" +
